...
const dw = 2e3
  ...
  , V7 = 7
function setup() {
  windowHeight >= 1.2 * windowWidth ? (ww = windowWidth,
    wh = 1.2 * windowWidth) : (wh = windowHeight,
      ww = windowHeight / 1.2),
    wr = ww / dw,
...
function fSeg(a, b, c, e, f, g, h, i) {
  fill(a[0], a[1], a[2]),
    b ? (stroke(0, 0, 10),
      swght(w(.001))) : (stroke(a[0], a[1], a[2]),
        swght(w(5e-4)))
  const j = []
    , k = []
  for (let l = f; l < g; l += .01)
    j.push(l),
      k.unshift(l)
  j.push(g),
    beginShape()
...
const wht = [40, 2, 98]
  ...
  , pcAM = function () {
    return wc([[260, 20, 20], .77, [240, 30, 35], .03, [300, 10, 50], .05, [180, 20, 30], .06, [130, 20, 70], .05, [5, 10, 80], .02, [5, 40, 90], .01, [40, 25, 90], .01])
  }
  , pbcAM = function () {
    return [260, 30, 30]
  }
  , pcDarkLifestyle = function () {
    return wc([[0, 0, 13], .2, [0, 0, 16], .48, [0, 0, 19], .2, [0, 0, 22], .1, [0, 0, 25], .02])
  }
  ...
  , pcRose = function () {
    return wc([[150, 8, 40], .5, [160, 12, 25], .05, [350, 60, 90], .05, [350, 45, 80], .05, [350, 80, 70], .05, [6, 16, 100], .2, [15, 26, 97], .1])
  }
  , pbcRose = function () {
    return [150, 8, 30]
  }
...
function draw() {
  ...
  let e, f = null
  "bkd" === d ? (e = pcBaked,
    f = pbcBaked) : "luxe" === d ? (e = pcLx,
      f = pbcLx) : "lD" === d ? (e = makeLxD(),
        f = pbcLx) : "cool" === d ? (e = pcCool,
          f = pbcCool) : "rad" === d ? (e = pcRad,
            f = pbcRad) : "pltq" === d ? (e = pcPolitique,
              f = pbcPolitique) : "retro" === d ? (e = pcRetro,
                f = pbcRetro) : "blk" === d ? (e = pcBlack,
                  f = pbcBlack) : "wM" === d ? (e = pcWhtMono,
                    f = pbcWhtMono) : "AM" === d ? (e = pcAM,
                      f = pbcAM) : "dL" === d ? (e = pcDarkLifestyle,
                        f = pbcDarkLifestyle) : "pG" === d ? (e = pcPartyGirl,
                          f = pbcPartyGirl) : "wOC" === d ? (e = pcWhtOnCrm,
                            f = pbcWhtOnCrm) : "gS" === d ? (e = pcGolfSocks,
                              f = pbcGolfSocks) : "rose" === d ? (e = pcRose,
                                f = pbcRose) : (e = pcLx,
                                  f = pbcLx)
  const g = a !== V7 && od(.6)
  let i = "high"
  ...
  let l = 150
  a === V1 ? l = gssn(10, 10) : a === V2 ? l = gssn(40, 30) : a === V3 ? l = gssn(90, 50) : a === V5 ? l = gssn(150, 50) : a === V6 ? l = gssn(200, 50) : a === V7 && (l = gssn(200, 50)),
    l = Math.max(5, l)
  let m = []
    , n = h(.017)
  if (a === V1) {
