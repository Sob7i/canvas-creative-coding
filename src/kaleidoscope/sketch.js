/* Creating a variable called `tSide` and setting it to 450. */
let tSide = 250;
...
function draw() {
  ...
  // const imgAspectR = img.height / img.width;
  // let imgWidth = img.width;
  // let imgHeight = imgWidth * imgAspectR;
...
function createShape(img, reflect, rotations) {
  ...
  const b = tHeight - a;
  // c is difference bewtween a and b (the center of the triangle and the center of the graphics object)
  const c = b - tHeight / 2
